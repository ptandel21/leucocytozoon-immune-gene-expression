...
Analyze expression levels of immune-related genes (e.g., MAP4K4, HEBP1, TLR7) using both targeted statistical comparisons and global visualization tools like heatmaps. This allows for validation of specific targets and discovery of broader expression trends in infected versus uninfected barn owls.
